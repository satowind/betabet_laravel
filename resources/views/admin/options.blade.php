                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="option{{$option->id}}" placeholder="" value='{{$option->option_value}}'>
...
<script>
    $('.approve').on('click', function() {
        ...
        let id = $(this).data('id');
        let value = $(this).parent().prev().find('input').val();
            ...
            buttons: {
                confirm: function () {
                    $.ajax({
                        ...
                        error: function() {
                            window.location = "{{url('/admin/options/erroru')}}";
                        },
                        dataType: 'text',
                        success: function() {
                            window.location = "{{url('/admin/options/updated')}}";
                        },
