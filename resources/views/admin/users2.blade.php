...
@section('content')
        ...
        <h2>Old Customers <small class="text-danger">please check you local database and update their details accordingly</small></h2>
        ...
        <table class="table table-striped table-bordered" id="table-1">
            ...
            <tbody>
                @foreach($customers as $customer)
                    ...
                    <td><a  href="{{url('admin/editusers_old')}}/{{$customer->id}}" type="button" class="btn btn-primary btn-sm done">
                            Edit
                        </a></td>
                    </tr>
                @endforeach
