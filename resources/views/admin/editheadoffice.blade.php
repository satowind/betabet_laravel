    ...
    <div class="form-group ">
      ...
      <div class="form-group">
       ...
       <label for="client-email"><h3 class="h3 text-danger">Country</h3></label>
            <select class="form-control input-lg" id="national" name="national"  >
   ...
   <label for="client-email"><h3 class="h3 text-danger">Local Government</h3></label> 
    ...
    <div class="col-sm-12">
        ...
        <div class="pull-right">
            ...
            <a href="{{url('admin/head_office')}}" type="button" class="btn btn-lg btn-primary">Cancel</a>
            ...
            buttons: {
                confirm: function () {
                    $.ajax({
                        ...
                        error: function() {
                            window.location = "{{url('/admin/head_office/errord')}}";
                        },
                        dataType: 'text',
                        success: function() {
                            window.location = "{{url('/admin/head_office/deleted')}}";
       ...
       $.confirm({
           ...
           buttons: {
               confirm: function () {
                   $.ajax({
                       type: 'POST',
                       url: "{{url('/admin/update_headoffice')}}",
                        data: {
                            id:id,
                            name:name,
                            email:email,
                        ...
                        error: function() {
                            window.location = "{{url('/admin/head_office/erroru')}}";
                        },
                        dataType: 'text',
                        success: function() {
                            window.location = "{{url('/admin/head_office/update')}}";
