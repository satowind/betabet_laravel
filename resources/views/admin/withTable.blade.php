                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if( $transactions->status==1 )
                            <a href="{{url('/admin/editbranchoffice')}}{{'/'.$transactions->id}}" class="btn btn-primary btn-sm done"> Withdraw Account    <span class="fa fa-money"></span></a>
                    ...
                    <td>
                        ...
                        @elseif($transactions->status==2)
                            <h5 style="color:blue">Withdrawn</h5>
                        @else
                            <h5 style="color:red">Rejected</h5>
