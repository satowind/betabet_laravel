...
<form action="#" method="post" class="row">
    ...
    <div class="col-sm-12">
        <br><br>
        <a href="{{url('admin/area_office')}}"  class="btn btn-lg btn-default">Cancel</a>
        <button type="button" onclick="add_areaoffice()" class="btn btn-lg btn-success pull-right" name="addFAQ">Add</button>
    </div>
</form>
            </div></div></div>
                ...
                buttons: {
                    confirm: function () {
                        $.ajax({
                            ...
                            error: function() {
                                window.location = "{{url('/admin/area_office/errora')}}";
                            },
                            dataType: 'text',
                            success: function() {
                                window.location = "{{url('/admin/area_office/add')}}";
