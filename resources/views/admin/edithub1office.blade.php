...
<div class="container ">
    <div class="row well">
        <div class="col-sm-6 col-sm-offset-3 ">
                ...
                <form action="#" method="post" class="row ">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="pull-right">
                            ...
                            <a href="{{url('admin/hub1_office')}}" type="button" class="btn btn-lg btn-primary">Cancel</a>
            ...
            @endif
            @if(!$branch)
                <h3>Something went wrong head  <a class="btn btn-danger btn-lg" href="{{url('/admin/hub1_office/errore')}}">Back</a></h3>
            @endif
        </div>
    </div>
</div>
            ...
            buttons: {
                confirm: function () {
                    $.ajax({
                        ...
                        error: function() {
                            window.location = "{{url('/admin/hub1_office/errord')}}";
                        },
                        dataType: 'text',
                        success: function() {
                            window.location = "{{url('/admin/hub1_office/deleted')}}";
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        $.ajax({
                            type: 'POST',
                            url: "{{url('/admin/update_hub1office')}}",
                            data: {
                                id:id,
                                name:name,
                                email:email,
                            ...
                            error: function() {
                                window.location = "{{url('/admin/hub1_office/erroru')}}";
                            },
                            dataType: 'text',
                            success: function() {
                                window.location = "{{url('/admin/hub1_office/update')}}";
