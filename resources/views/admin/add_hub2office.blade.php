        ...
        <div class="row well">
            <div class="col-sm-6 col-sm-offset-3">
                <form action="#" method="post" class="row">
                    ...
                    <div class="col-sm-12">
                        <br><br>
                        <a href="{{url('admin/hub2_office')}}"  class="btn btn-lg btn-default">Cancel</a>
                        <button type="button" onclick="add_hub2office()" class="btn btn-lg btn-success pull-right" name="addFAQ">Add</button>
                    </div>
                </form>
</div></div></div>
                ...
                buttons: {
                    confirm: function () {
                        $.ajax({
                            ...
                            error: function() {
                                window.location = "{{url('/admin/hub2_office/errora')}}";
                            },
                            dataType: 'text',
                            success: function() {
                                window.location = "{{url('/admin/hub2_office/add')}}";
