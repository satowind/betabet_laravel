...
// RMS4CC (Royal Mail 4-state Customers Code) - CBC (Customers Bar Code)
$pdf->Cell(0, 0, 'RMS4CC (Royal Mail 4-state Customers Code) - CBC (Customers Bar Code)', 0, 1);
$pdf->write1DBarcode('SN34RD1A', 'RMS4CC', '', '', 80, 20, 0.4, $style, 'N');

$pdf->Ln();

// KIX (Klant index - Customers index)
$pdf->Cell(0, 0, 'KIX (Klant index - Customers index)', 0, 1);
